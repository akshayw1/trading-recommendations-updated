...
export default function Sui() {
  ...
  const updateData = async (dataSelect = "Sui") => {
    let newData;
    if (dataSelect === "Sui") {
      newData = [...data];
    } else if (dataSelect === "chartDataSui") {
      newData = [...chartData];
    } else {
  ...
  const getData = async (dataSelect = "Sui") => {
    try {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const dataFetch2 = await getData("freeTextSui");
        const dataFetch3 = await getData("chartDataSui");
                ...
                <tr>
                  <td colSpan="5">
                    <div className="flex flex-start">
                      ...
                      <button
                        onClick={() => updateData("freeTextSui")}
                        className="w-48 text-center bg-blue-700 h-12 hover:bg-blue-600"
                      >
                        Update
                      </button>
                ...
                <tr>
                  <td colSpan="5">
                    <div className="flex flex-start">
                      ...
                      <button
                        onClick={() => updateData("chartDataSui")}
                        className="w-48 text-center bg-blue-700 h-12 hover:bg-blue-600"
                      >
                        Update
                      </button>
