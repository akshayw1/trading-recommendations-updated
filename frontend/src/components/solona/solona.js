...
export default function Solona() {
  ...
  const updateData = async (dataSelect = "Solona") => {
    let newData;
    if (dataSelect === "Solona") {
      newData = [...data];
    } else if (dataSelect === "chartDataSolona") {
      newData = [...chartData];
    } else {
  ...
  const getData = async (dataSelect = "Solona") => {
    try {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const dataFetch2 = await getData("freeTextSolona");
        const dataFetch3 = await getData("chartDataSolona");
                ...
                <tr>
                  <td colSpan="5">
                    <div className="flex flex-start">
                      ...
                      <button
                        onClick={() => updateData("freeTextSolona")}
                        className="w-48 text-center bg-blue-700 h-12 hover:bg-blue-600"
                      >
                        Update
                      </button>
                ...
                <tr>
                  <td colSpan="5">
                    <div className="flex flex-start">
                      ...
                      <button
                        onClick={() => updateData("chartDataSolona")}
                        className="w-48 text-center bg-blue-700 h-12 hover:bg-blue-600"
                      >
                        Update
                      </button>
